...
// //   // ✏️ प्रत्यकासाठी स्वतंत्र Inline Edit State (सुरवातीला सर्व ReadOnly)
...
// //         elevation: 0,
// //         title: const Text('Shop Profile Management', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 18)),
// //         leading: IconButton(
...
// //                         const Text('PROTECTED OPERATOR CREDENTIALS (LOCKED)', style: TextStyle(color: Color(0xFFEF4444), fontWeight: FontWeight.bold, fontSize: 11, letterSpacing: 1)),
// //                         const SizedBox(height: 14),

// //                         _buildLockedField(label: 'USERNAME', controller: _usernameController, icon: Icons.person_pin_rounded),
// //                         const SizedBox(height: 14),
// //                         _buildLockedField(label: 'MOBILE NUMBER', controller: _phoneController, icon: Icons.phone_android_rounded),
// //                         const SizedBox(height: 14),
// //                         _buildLockedField(label: 'EMAIL ADDRESS', controller: _emailController, icon: Icons.mail_outline_rounded),
// //                         const SizedBox(height: 28),

// //                         // ✏️ EDITABLE FIELDS
// //                         const Text('EDITABLE SHOP INFORMATION', style: TextStyle(color: Color(0xFF10B981), fontWeight: FontWeight.bold, fontSize: 11, letterSpacing: 1)),
// //                         const SizedBox(height: 14),

// //                         // 1. Shop Name
// //                         _buildInlineEditableField(keyKey: 'shopName', controller: _shopNameController, label: 'Shop / Business Name *', icon: Icons.storefront_rounded),
// //                         const SizedBox(height: 16),

// //                         // 2. Owner Legal Name
// //                         _buildInlineEditableField(keyKey: 'ownerName', controller: _ownerNameController, label: 'Owner Legal Name *', icon: Icons.person_outline_rounded),
// //                         const SizedBox(height: 16),

// //                         // 3. Business Category
// //                         _buildInlineEditableField(keyKey: 'category', controller: _categoryController, label: 'Business Category *', icon: Icons.category_outlined, isCategoryDropdown: true),
// //                         const SizedBox(height: 16),

// //                         // 4. GSTIN Number
// //                         _buildInlineEditableField(keyKey: 'gstin', controller: _gstinController, label: 'Corporate GSTIN Number', icon: Icons.receipt_long_rounded),
// //                         const SizedBox(height: 16),

// //                         // 5. UPI ID
// //                         _buildInlineEditableField(keyKey: 'upi', controller: _upiController, label: 'Business UPI Payment ID', icon: Icons.qr_code_rounded),
// //                         const SizedBox(height: 16),

// //                         // 6. Shop Address
// //                         _buildInlineEditableField(keyKey: 'address', controller: _addressController, label: 'Physical Shop Address *', icon: Icons.location_on_outlined, maxLines: 2),
// //                         const SizedBox(height: 32),
...
// //                             label: Text(_isSaving ? 'Saving Changes...' : 'Save Profile Changes', style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 15)),
...
// //   // 🔒 Locked Field
// //   Widget _buildLockedField({required String label, required TextEditingController controller, required IconData icon}) {
// //     return TextFormField(
// //       controller: controller,
// //       readOnly: true, // ReadOnly keeps it uneditable but allows layout consistency
...
// //   // ✏️ FIX: readOnly: !isEnabled वापरल्याने Pencil Icon Click 100% Work होईल!
...
// //     return TextFormField(
// //       controller: controller,
// //       readOnly: !isEnabled, // 💡 FIX: readOnly वापरल्याने Suffix Icon clickable राहतो!
// //       maxLines: maxLines,
// //       style: TextStyle(color: isEnabled ? Colors.white : Colors.white70, fontWeight: FontWeight.bold, fontSize: 14),
// //       decoration: InputDecoration(
// //         labelText: label,
...
// //         border: OutlineInputBorder(borderRadius: BorderRadius.circular(10), borderSide: BorderSide(color: isEnabled ? const Color(0xFF38BDF8) : Colors.white12, width: isEnabled ? 1.5 : 1)),
...
//   // 🔔 ULTRA-PROFESSIONAL TOP FLOATING NOTIFICATION (iOS, Android, Web Compatible)
...
//               boxShadow: [
//                 BoxShadow(
//                   color: (isError ? Colors.red : Colors.white).withOpacity(0.35),
//                   blurRadius: 20,
//                   spreadRadius: 2,
