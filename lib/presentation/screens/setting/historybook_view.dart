  ...
  Future<void> _restoreEntireSession(
    ...
    try {
      ...
      await NotificationService.sendNotification(
        ...
        body: 'Restored ${docs.length} entries for $customerName back to live ledger.',
        type: 'add',
      );
  ...
  Future<void> _deleteEntireSession(
    ...
    try {
      ...
      if (docs.isNotEmpty) {
        ...
        customerName = firstData['customerName'] ?? 'Customer';
      }
      ...
      await NotificationService.sendNotification(
        ...
        body: 'Permanently deleted session batch (${docs.length} entries) for $customerName.',
        type: 'delete',
      );
