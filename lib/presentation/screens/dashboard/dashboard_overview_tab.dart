...
// // //   // ⚡ Jitter-free Hovering with ValueNotifier (Prevents whole screen rebuilds/shaking)
...
// // //               // 📈 3. REAL-TIME HIGH-PERFORMANCE BAR GRAPH PANEL (JITTER-FREE)
// // //               Container(
// // //                 padding: const EdgeInsets.all(18),
// // //                 decoration: BoxDecoration(
// // //                   color: widget.cardBgColor,
...
// // //                     // ⚡ Jitter-Free Interactive Value Banner
...
// // //                     // 🎨 Premium Chart Canvas with Smooth Hover/Touch Event Handling
// // //                     LayoutBuilder(
// // //                       builder: (context, chartConstraints) {
// // //                         return Listener(
...
// // // // 🎨 ULTRA-PROFESSIONAL GRADIENT BAR CHART PAINTER
// // // class RealMetricsBarChartPainter extends CustomPainter {
// // //   final List<Map<String, dynamic>> data;
// // //   final bool isDark;
// // //   final int? hoveredIndex;
...
// // //     // 2. Render Bars with Gradient & Curved Tops
// // //     for (int i = 0; i < count; i++) {
// // //       final item = data[i];
// // //       final groupX = i * groupWidth + groupWidth / 2;
...
// // //       // Credit Bar (Emerald Green Gradient)
...
// // //     // 3. Highlight Node Marker on Hover
// // //     if (hoveredIndex != null && hoveredIndex! < count) {
// // //       final idx = hoveredIndex!;
// // //       final hoverX = idx * groupWidth + groupWidth / 2;
...
// //           key: const PageStorageKey<String>('dashboard_overview_scroll_key'),
// //           physics: const ClampingScrollPhysics(),
// //           // 🟢 Bottom padding set to 140px so content scrolls safely above floating nav bars and buttons
// //           padding: EdgeInsets.only(
// //             left: isDesktop ? 24 : (isTablet ? 18 : 14),
// //             right: isDesktop ? 24 : (isTablet ? 18 : 14),
// //             top: 10,
...
// //             crossAxisAlignment: CrossAxisAlignment.stretch,
// //             children: [
// //               // 📊 1. EXECUTIVE METRICS CARDS WITH STATUS CIRCLES
// //               _buildExecutiveMetricsGrid(
// //                 totalCustomers: totalCustomers,
// //                 totalDebit: totalDebit,
// //                 totalCredit: totalCredit,
...
// //                     // 🎨 Chart Canvas with Hover/Touch Event Handling
// //                     LayoutBuilder(
// //                       builder: (context, chartConstraints) {
// //                         return Listener(
// //                           onPointerDown: (event) => _updateHoverIndex(event.localPosition.dx, chartConstraints.maxWidth, graphBarData.length),
...
// //           icon: netBalance >= 0 ? Icons.account_balance_rounded : Icons.warning_amber_rounded,
// //           accentColor: netBalance >= 0 ? const Color(0xFF0066CC) : const Color(0xFFF59E0B),
// //           circleColor: netBalance >= 0 ? const Color(0xFF0066CC) : const Color(0xFFF59E0B),
// //           subtitle: netBalance >= 0 ? 'Surplus Cashflow' : 'Deficit Alert',
// //         ),
// //       ],
// //     );
...
// //   // 🔘 METRIC CARD WITH DISTINCT TITLE CIRCLE STATUS INDICATOR
// //   Widget _buildMetricCard({
// //     required String title,
// //     required String value,
// //     required IconData icon,
...
// //                 child: Row(
// //                   children: [
// //                     // 🟢 Title Status Color Indicator Circle
// //                     Container(
// //                       width: 8,
// //                       height: 8,
// //                       decoration: BoxDecoration(
...
//             right: isDesktop ? 24 : (isTablet ? 18 : 14),
//             top: 10,
//             bottom: 140, // 🟢 Extra bottom padding prevents floating widgets from hiding content
//           ),
//           child: Column(
//             crossAxisAlignment: CrossAxisAlignment.stretch,
//             children: [
//               // 📊 1. EXECUTIVE METRICS CARDS WITH PROFESSIONAL TITLE CIRCLES
//               _buildExecutiveMetricsGrid(
//                 totalCustomers: totalCustomers,
...
//       crossAxisSpacing: 12,
//       mainAxisSpacing: 12,
//       childAspectRatio: isDesktop ? 1.6 : (isTablet ? 2.0 : 2.4),
//       children: [
//         _buildMetricCard(
//           title: 'Total Active Clients',
//           value: '$totalCustomers',
...
//           accentColor: const Color(0xFFEF4444),
//           circleColor: const Color(0xFFEF4444),
//           subtitle: 'Payable Liabilities • $totalDebitClients Clients',
//         ),
//         _buildMetricCard(
//           title: "You'll Get (Credit)",
//           value: '₹${totalCredit.toStringAsFixed(2)}',
...
//           accentColor: const Color(0xFF10B981),
//           circleColor: const Color(0xFF10B981),
//           subtitle: 'Receivable Assets • $totalCreditClients Clients',
//         ),
//         _buildMetricCard(
//           title: 'Net Portfolio Balance',
//           value: '₹${netBalance.abs().toStringAsFixed(2)}',
...
//           accentColor: netBalance >= 0 ? const Color(0xFF0066CC) : const Color(0xFFF59E0B),
//           circleColor: netBalance >= 0 ? const Color(0xFF0066CC) : const Color(0xFFF59E0B),
//           subtitle: netBalance >= 0 ? 'Surplus Cashflow Position' : 'Deficit Alert',
//         ),
//       ],
//     );
//   }

//   // 🔘 METRIC CARD WITH GLOWING PROFESSIONAL CIRCLE DOT
//   Widget _buildMetricCard({
//     required String title,
//     required String value,
//     required IconData icon,
...
//                 child: Row(
//                   children: [
//                     // 🟢 Professional Status Circle Dot with Glow
//                     Container(
//                       width: 9,
//                       height: 9,
//                       decoration: BoxDecoration(
