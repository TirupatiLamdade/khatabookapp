...
// // // //   // 🗺️ ROUTE NAVIGATION MAP POPUP (YOUR LOCATION ➔ CUSTOMER LOCATION)
...
// // // //               // 📍 ROUTE CONNECTOR UI (YOUR LOCATION -> CUSTOMER LOCATION)
// // // //               Container(
...
// // // //               // 🗺️ MAP PREVIEW CONTAINER DISPLAY
// // // //               Container(
// // // //                 height: 120,
...
// // // //   // 🚀 LAUNCH DIRECT ROUTE MAP (FROM CURRENT LOCATION TO CUSTOMER LOCATION)
...
// // // //   // 🎯 OVERFLOW-FREE & NO-STRIPE CUSTOMER CARD WIDGET
...
// // // //             children: [
// // // //               // 1️⃣ LEFT: DETAILS (NAME, PHONE, DATE)
// // // //               Expanded(
// // // //                 child: Column(
// // // //                   crossAxisAlignment: CrossAxisAlignment.start,
// // // //                   mainAxisSize: MainAxisSize.min,
...
// // // //               // 2️⃣ RIGHT: COMPACT ACTIONS ROW (OVERFLOW FREE)
// // // //               Row(
// // // //                 mainAxisSize: MainAxisSize.min,
// // // //                 children: [
// // // //                   Text(
...
// // //   // 🎉 🟢 FIRST TIME LOGIN CONGRATULATIONS POP-UP DIALOG
...
// // //               constraints: const BoxConstraints(maxWidth: 380), // 📐 Responsive width
// // //               child: Column(
// // //                 mainAxisSize: MainAxisSize.min,
// // //                 children: [
// // //                   Container(
...
// // //                         // 🟢 Update Firestore flag so pop-up won't appear again
...
// //                       children: [
// //                         IconButton(
// //                           icon: const Icon(Icons.notifications_rounded, color: Color(0xFF38BDF8), size: 22),
...
// //               const SizedBox(width: 4),
// //               IconButton(
// //                 icon: const Icon(Icons.delete_sweep_rounded, color: Colors.amber, size: 22),
// //                 padding: const EdgeInsets.all(6),
// //                 constraints: const BoxConstraints(),
// //                 onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (context) => const RecycleBinScreen())),
// //               ),
// //               const SizedBox(width: 4),
// //               IconButton(
// //                 icon: Icon(_showArchived ? Icons.archive_rounded : Icons.archive_outlined, color: _showArchived ? const Color(0xFF38BDF8) : Colors.grey, size: 22),
// //                 padding: const EdgeInsets.all(6),
// //                 constraints: const BoxConstraints(),
// //                 onPressed: () {
// //                   setState(() => _showArchived = !_showArchived);
...
// //                 padding: const EdgeInsets.only(right: 8.0),
// //                 child: IconButton(
// //                   icon: const Icon(Icons.storefront_rounded, color: Color(0xFF38BDF8), size: 22),
// //                   padding: const EdgeInsets.all(6),
// //                   constraints: const BoxConstraints(),
// //                   onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (context) => const ProfileScreen())),
// //                 ),
...
// //         ],
// //       ),
// //       // 🎯 HIDE "ADD NEW CUSTOMER" BUTTON WHEN NOTIFICATION PANEL IS OPEN
...
//             mainAxisSize: MainAxisSize.min,
//             children: [
//               // 🔔 DYNAMIC BELL ICON (GOLDEN YELLOW ON MSG + RED BADGE COUNT)
//               StreamBuilder<QuerySnapshot>(
//                 stream: FirebaseFirestore.instance
//                     .collection('notifications')
//                     .where('operatorUid', isEqualTo: currentUser.uid)
...
//                   // 🟡 Message असल्यास Golden/Yellow रंगाचा बेल आयकॉन
//                   final Color bellColor = unreadCount > 0 
//                       ? const Color(0xFFFACC15) // Golden Yellow
//                       : const Color(0xFF38BDF8); // Standard Electric Cyan
...
//                       children: [
//                         IconButton(
//                           icon: Icon(Icons.notifications_rounded, color: bellColor, size: 24),
//                           padding: const EdgeInsets.all(6),
//                           constraints: const BoxConstraints(),
//                           onPressed: () {
//                             setState(() {
