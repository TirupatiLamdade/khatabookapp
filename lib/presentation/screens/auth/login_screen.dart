...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  void _handleLogin() async {
    ...
    // 🚧 इथे तुमची एक्चुअल Firebase Auth इंटिग्रेशन येईल
    // सध्यातरी डेटाबेस कनेक्शन आणि मल्टि-टेनंट टेस्टिंगसाठी आपण डमी लॉगिन करत आहोत
    await Future.delayed(const Duration(seconds: 2));
    
    if (_emailController.text.isNotEmpty && _passwordController.text.isNotEmpty) {
      // मल्टि-शॉप आयसोलेशनसाठी युझरच्या ईमेलनुसार डमी शॉप आयडी सेट करू
      String assignedShopId = "SHOP_${_emailController.text.split('@')[0].toUpperCase()}";
      
      // ग्लोबल हबमध्ये शॉप आयडी अपडेट करा
      ref.read(activeShopIdProvider.notifier).state = assignedShopId;
      ...
      setState(() => _isLoading = false);
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('कृपया योग्य ईमेल आणि पासवर्ड टाका')),
      );
    }
  }
                ...
                children: [
                  Center(
                    child: Icon(Icons.account_balance_wallet, 
                      size: 64, color: Colors.deepPurple.shade700),
                  ),
                  const SizedBox(height: 16),
                  Center(
                    child: Text(
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: _isLoading
                          ? const CircularProgressIndicator(color: Colors.white)
                          : const Text('लॉगिन करा', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                    ),
                  ),
                ],
              ),
