...
//     Key? key,
//     this.shopOwnerName = "Business Owner",
//   }) : super(key: key);
...
//   // 🔑 YOUR API KEY (Passed via Headers)
...
//   // 🔄 Dynamic Speech Bubble Messages
//   Timer? _tooltipTimer;
//   int _currentTooltipIndex = 0;
//   final List<String> _dynamicTooltips = [
//     "Hey, Hello! 👋",
//     "Khatabook Smart 📊",
//     "May I Help You? 🤖",
//     "Need Ledger Help? 💰",
...
//     // 🤖 Dynamic Welcome Message with Shop Owner Name
//     _messages = [
//       AiChatMessage(
//         text: "Welcome to Khatabook Smart, ${widget.shopOwnerName}! 👋\nHow can I help you manage your business accounts today?",
//         isUser: false,
//       ),
//     ];

//     // ⏱️ Swapping Speech Bubble Messages Every 3 Seconds
...
//   // 🌐 Gemini API Request using X-goog-api-key Header
...
//     try {
//       // 🟢 Exact endpoint matching your working cURL structure
//       final url = Uri.parse(
...
//           'X-goog-api-key': _geminiApiKey, // 🔑 Standard Header Authentication
//         },
//         body: jsonEncode({
//           "contents": [
//             {
...
//               ),
//             )
//           : _buildRobotButtonWithDynamicSpeechBubble(isDark),
//     );
//   }

//   // 🤖 Dynamic Changing Speech Bubble + Floating Robot Button
//   Widget _buildRobotButtonWithDynamicSpeechBubble(bool isDark) {
//     return Stack(
...
//                       const Text('Online • Gemini Flash', style: TextStyle(color: Color(0xFF10B981), fontWeight: FontWeight.bold, fontSize: 9.5)),
//                     ],
//                   ),
//                 ),
//                 IconButton(
